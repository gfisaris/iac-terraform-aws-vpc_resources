...
##  AWV VPC Resources  ##
  ...
  variable "aws_vpc_ecs_cluster_cidr_block" {
    type="string"
    description = "ECS Cluster VPC Internal IP Range (Example: 192.168.0.0/20)"
  }
  ...
  ## ECS Cluster VPC - Subnets
    ...
    variable "aws_vpc_subnet_ecs_cluster_public_cidr_block" {
      type="list"
      description = "ECS Cluster Public VPC Subnets Internal IP Range (Example:\"192.168.1.0/24\", \"192.168.2.0/24\", \"192.168.3.0/24\")"
    }
    ...
    variable "aws_vpc_subnet_ecs_cluster_private_cidr_block" {
      type="list"
      description = "ECS Cluster Private VPC Subnets Internal IP Range (Example:\"192.168.4.0/24\", \"192.168.5.0/24\", \"192.168.6.0/24\")"
    }
