resource "aws_route_table_association" "ecs_cluster_public" {
  count           = "${var.aws_vpc_subnet_ecs_cluster_public_count * var.aws_vpc_ecs_cluster_enabled}"
...
resource "aws_route_table_association" "ecs_cluster_private" {
  count           = "${var.aws_vpc_subnet_ecs_cluster_private_count * var.aws_vpc_ecs_cluster_enabled}"
